...
class __TwigTemplate_4c42745cad320941cebbbf557d88f3b2 extends Template
{
...
<div ";
  ...
  <div class=\"admin-toolbar-control-bar__content\">
    ";
        // line 23
        yield from $this->loadTemplate("navigation:toolbar-button", "core/modules/navigation/layouts/navigation.html.twig", 23)->unwrap()->yield(CoreExtension::toArray(["attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["aria-expanded" => "false", "aria-controls" => "admin-toolbar", "type" => "button"]), "icon" => "burger", "text" => t("Expand sidebar"), "modifiers" => ["small-offset"], "extra_classes" => ["admin-toolbar-control-bar__burger"]]));
        // line 32
        yield "  </div>
</div>
...
>
  ...
  <div class=\"admin-toolbar__scroll-wrapper\">
      ...
      ";
        ...
        if ( !CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "settings", [], "any", false, false, true, 48), "hide_logo", [], "any", false, false, true, 48)) {
            ...
            if ( !(null === CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "settings", [], "any", false, false, true, 50), "logo_path", [], "any", false, false, true, 50))) {
                ...
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "settings", [], "any", false, true, true, 51), "logo_width", [], "any", true, true, true, 51)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "settings", [], "any", false, true, true, 51), "logo_width", [], "any", false, false, true, 51), 40)) : (40)), "html", null, true);
                yield "\" height=\"";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "settings", [], "any", false, true, true, 51), "logo_height", [], "any", true, true, true, 51)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "settings", [], "any", false, true, true, 51), "logo_height", [], "any", false, false, true, 51), 40)) : (40)), "html", null, true);
                yield "\">
            ";
            } else {
                // line 53
                yield "              ";
                yield from $this->loadTemplate("@navigation/logo.svg.twig", "core/modules/navigation/layouts/navigation.html.twig", 53)->unwrap()->yield(CoreExtension::toArray(["label" => t("Navigation logo")]));
                // line 56
                yield "            ";
            }
            // line 57
        ...
        // line 59
        yield "        ";
        yield from $this->loadTemplate("navigation:toolbar-button", "core/modules/navigation/layouts/navigation.html.twig", 59)->unwrap()->yield(CoreExtension::toArray(["attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["data-toolbar-back-control" => true, "tabindex" => "-1"]), "extra_classes" => ["admin-toolbar__back-button"], "icon" => "back", "text" => t("Back")]));
        // line 65
        yield "        ";
        yield from $this->loadTemplate("navigation:toolbar-button", "core/modules/navigation/layouts/navigation.html.twig", 65)->unwrap()->yield(CoreExtension::toArray(["action" => t("Collapse sidebar"), "attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["aria-controls" => "admin-toolbar", "tabindex" => "-1", "type" => "button"]), "extra_classes" => ["admin-toolbar__close-button"], "icon" => "cross"]));
        // line 71
        yield "      </div>

      ";
        // line 73
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "content", [], "any", false, false, true, 73), "html", null, true);
        yield "
    </nav>
    ...
    ";
        ...
        // line 77
        yield "    <nav ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["region_attributes"] ?? null), "footer", [], "any", false, false, true, 77), "setAttribute", ["id", "menu-footer"], "method", false, false, true, 77), "addClass", ["admin-toolbar__footer"], "method", false, false, true, 77), "setAttribute", ["aria-labelledby", ($context["title_menu_footer"] ?? null)], "method", false, false, true, 77), "html", null, true);
        yield ">
      <h3 id=\"";
        // line 78
      ...
      ";
        // line 79
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "footer", [], "any", false, false, true, 79), "html", null, true);
        yield "
...
";
    ...
    {
        return array (  155 => 81,  150 => 79,  144 => 78,  139 => 77,  137 => 76,  131 => 73,  127 => 71,  124 => 65,  121 => 59,  117 => 57,  114 => 56,  111 => 53,  99 => 51,  97 => 50,  92 => 49,  90 => 48,  87 => 47,  81 => 45,  76 => 44,  74 => 43,  72 => 42,  67 => 39,  62 => 36,  56 => 32,  54 => 23,  49 => 21,  46 => 20,  44 => 19,);
    }
    ...
    {
        static $tags = array("set" => 19, "include" => 23, "if" => 48);
        static $filters = array("escape" => 21, "t" => 26, "clean_unique_id" => 42, "default" => 51);
        static $functions = array("create_attribute" => 19, "path" => 49);
