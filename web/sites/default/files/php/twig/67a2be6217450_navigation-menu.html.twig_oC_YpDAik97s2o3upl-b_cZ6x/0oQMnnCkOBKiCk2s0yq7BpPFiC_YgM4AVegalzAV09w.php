...
class __TwigTemplate_2ab80e38074eb36f6c877112dc288414 extends Template
{
...
";
    ...
    ";
          ...
          ";
                        // line 32
                        yield from $this->loadTemplate("navigation:toolbar-button", "core/modules/navigation/templates/navigation-menu.html.twig", 32)->unwrap()->yield(CoreExtension::toArray(["attributes" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,                         // line 33
...
function ($__v__) use ($context, $macros) { $context["v"] = $__v__; return  !(null === ($context["v"] ?? null)); })]));
      ...
      ";
          ...
          ";
                        // line 45
                        yield from $this->loadTemplate("navigation:toolbar-button", "core/modules/navigation/templates/navigation-menu.html.twig", 45)->unwrap()->yield(CoreExtension::toArray(["action" => t("Extend"), "attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["aria-expanded" => "false", "aria-controls" =>                         // line 49
...
$context["item"], "title", [], "any", false, false, true, 54), "modifiers" => ["expand--side", "collapsible"], "extra_classes" => ["toolbar-popover__control"]]));
            ...
            ";
                        ...
                        if (CoreExtension::getAttribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 64)) {
                            // line 65
                            yield "              ";
                            yield from $this->loadTemplate("navigation:toolbar-button", "core/modules/navigation/templates/navigation-menu.html.twig", 65)->unwrap()->yield(CoreExtension::toArray(["attributes" => CoreExtension::getAttribute($this->env, $this->source,                             // line 66
...
($context["menu_level"] ?? null) == 1)) {
        ...
        ";
                    ...
                    if (Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 101))) {
                        // line 102
                        yield "          ";
                        yield from $this->loadTemplate("navigation:toolbar-button", "core/modules/navigation/templates/navigation-menu.html.twig", 102)->unwrap()->yield(CoreExtension::toArray(["attributes" => CoreExtension::getAttribute($this->env, $this->source,                         // line 103
...
($context["item_link_tag"] ?? null) == "span")) ? ("toolbar-button--non-interactive") : (""))]]));
                        ...
                        // line 111
                        yield "          ";
                        yield from $this->loadTemplate("navigation:toolbar-button", "core/modules/navigation/templates/navigation-menu.html.twig", 111)->unwrap()->yield(CoreExtension::toArray(["attributes" => $this->extensions['Drupal\Core\Template\TwigExtension']->createAttribute(["aria-expanded" => "false", "data-toolbar-menu-trigger" =>                         // line 114
...
$context["item"], "title", [], "any", false, false, true, 132)))]), "html", null, true);
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("escape" => 3, "clean_unique_id" => 28, "default" => 33, "render" => 33, "clean_class" => 34, "filter" => 40, "t" => 46, "lower" => 132, "first" => 132);
        static $functions = array("constant" => 16, "create_attribute" => 23, "link" => 127);
